...
use App\Http\Controllers\Admin\ShipmentLogController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(SetupSmsController::class)->prefix('setup-sms')->name('setup.sms.')->group(function () {
        Route::controller(SmsProviderController::class)->prefix('providers')->name('providers.')->group(function () {
    ...
    Route::controller(ShipmentLogController::class)->prefix('shipment-log')->name('shipment.log.')->group(function () {
        Route::get('delivered', 'delivered')->name('delivered');
        Route::get('booked', 'booked')->name('booked');
        Route::get('shipment', 'shipment')->name('shipment');
        Route::get('way', 'way')->name('way');
        Route::get('status/update', 'statusUpdate')->name('status.update');
    ...
    Route::controller(CategoryController::class)->prefix('product-categories')->name('product.categories.')->group(function () {
        Route::get('index', 'index')->name('index');
    ...
    Route::controller(SubCategoryController::class)->prefix('product-sub-categories')->name('product.sub.categories.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('create', 'create')->name('create');
        Route::post('store', 'store')->name('store');
        Route::put('status/update', 'statusUpdate')->name('status.update');
    ...
    Route::controller(DeliverySettingsController::class)->prefix('delivery')->name('delivery.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::put('delivery/activation/update', 'deliveryActivationUpdate')->name('activation.update');
        Route::put('update', 'update')->name('update');
    });
