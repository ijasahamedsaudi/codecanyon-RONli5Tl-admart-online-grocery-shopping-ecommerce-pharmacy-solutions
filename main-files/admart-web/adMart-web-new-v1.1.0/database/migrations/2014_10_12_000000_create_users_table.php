...
return new class () extends Migration {
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->boolean('free_delivery_status')->comment('1 = used, 0 == unused')->default(true);
            $table->integer('total_spend_amount')->nullable();
            $table->integer('free_delivery_token')->nullable();
