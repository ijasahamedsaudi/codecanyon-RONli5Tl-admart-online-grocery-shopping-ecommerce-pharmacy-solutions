                ...
                <div class="card-header-user-area">
                    ...
                    <div class="card-header-user-content">
                        @if ($support_ticket->user_id != null)
                            <h6 class="title">{{ $support_ticket->creator->username }}</h6>
                        @endif

                        <span class="sub-title">{{ __('Ticket ID') }} : <span
                                class="text--danger">#{{ $support_ticket->token }}</span></span>
                ...
                <div class="chat-container messages">
                    <ul>
                        @foreach ($support_ticket->conversations ?? [] as $item)
                            <li
                                class="media media-chat @if ($item->receiver_type != 'ADMIN') media-chat-reverse sent @else replies @endif">
