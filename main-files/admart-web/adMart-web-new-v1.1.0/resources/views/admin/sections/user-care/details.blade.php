                ...
                <div class="row align-items-center mb-10-none">
                    ...
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list">
                            <li class="bg--base one">{{ __('Full Name') }}: <span>{{ $user->fullname ??'N/A' }}</span></li>
                            ...
                            <li class="bg--warning four">{{ __('Status') }}:
                                <span>{{ __($user->stringStatus->value) }}</span></li>
                        ...
                        <div class="row mb-10-none">
                            ...
                            <div class="col-xl-12 col-lg-12 form-group">
                                ...
                                <select name="wallet" id="wallet" class="form--control select2-auto-tokenize">
                                    <option disabled selected value="">{{ __('Select User Wallet') }}</option>
