...
@section("content")
    <div class="four-not-four-section">
        <div class="four-not-four-wrapper">
            ...
            <img src="{{ get_image("error-images/500-(Server-Error).png") }}" alt="500" class="error-bg">
                <div class="four-not-four-element-one">
                    <img src="{{ get_image("error-images/5.png") }}" alt="five">
                </div>
                <div class="four-not-four-element-two">
                    <img src="{{ get_image("error-images/0.png") }}" alt="zero">
                </div>
