...
@section("content")
    <div class="four-not-four-section">
        <div class="four-not-four-wrapper">
            ...
            <img src="{{ get_image("error-images/404.png") }}" alt="404" class="error">
            <img src="{{ get_image("error-images/403-(Accress-Denied).png") }}" alt="403" class="error-bg">
                <div class="four-not-four-element-one">
                    <img src="{{ get_image("error-images/4-curve.png") }}" alt="four-curve">
                </div>
                <div class="four-not-four-element-two">
                    <img src="{{ get_image("error-images/3.png") }}" alt="three">
                </div>
                <div class="four-not-four-element-three">
                    <img src="{{ get_image("error-images/socket.png") }}" alt="socket">
                </div>
                <div class="four-not-four-element-four">
                    <img src="{{ get_image("error-images/electric-socket.png") }}" alt="electric-socket">
                </div>
                <div class="four-not-four-element-five">
                    <img src="{{ get_image("error-images/tester.png") }}" alt="tester">
                </div>
