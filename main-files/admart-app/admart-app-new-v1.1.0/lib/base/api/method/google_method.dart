...
final log = logger(ApiMethodGoogle);

Map<String, String> googleHeaderInfo() {
  return {
    'X-client-type': 'app',
...
class ApiMethodGoogle {
  // ApiMethodGoogle({required this.isBasic});
  ...
  Future<Map<String, dynamic>?> multipartMultiFileModified(
    String url,
    Map<String, dynamic> body, {
    // Changed body type to Map<String, dynamic>
    int code = 200,
    bool showResult = false,
    required List<String> pathList,
    required List<String> fieldList,
    ...
    try {
      ...
      final request = http.MultipartRequest(
        ...
        ..fields.addAll(stringBody) // Add converted body
        ..headers.addAll(
          googleHeaderInfo(),
        );
